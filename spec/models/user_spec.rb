...
describe User do
  ...
  before do
    @user = User.new(name: "Anatoliy Khan", email: "aktee@mail.ru",
                     password: "toshka", password_confirmation: "toshka")
  end
  ...
  describe "micromessage associations" do
    ...
    before do
      ...
      3.times { followed_user.micromessages.create!(content: "Lorem ipsum") }
    end
    ...
    its(:feed) do
      followed_user.micromessages.each do |micromessage|
        should include(micromessage)
        end
      end
    end
  end
